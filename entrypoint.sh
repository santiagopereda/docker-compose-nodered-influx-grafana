...
export INFLUXDB_V2_LOG_LEVEL=$INFLUXDB_V2_LOG_LEVEL

export GF_DEFAULT_INSTANCE_NAME=$GF_DEFAULT_INSTANCE_NAME
export GF_AUTH_DISABLE_LOGIN_FORM=$GF_AUTH_DISABLE_LOGIN_FORM
export GF_AUTH_ANONYMOUS_ENABLED=$GF_AUTH_ANONYMOUS_ENABLED
export GF_AUTH_ANONYMOUS_ORG_ROLE=$GF_AUTH_ANONYMOUS_ORG_ROLE
